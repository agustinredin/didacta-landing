...
export function OnboardingModal({ isOpen, onClose }: OnboardingModalProps) {
  ...
  const [verificationEmailError, setVerificationEmailError] = useState<string | null>(
    null,
  );
  ...
  const sendVerificationEmail = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.API_URL}/verification-email`,
        {
          method: "POST",
          headers: {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {verificationEmailError && (
                  <p className="text-red-500 text-sm mt-3 font-mono uppercase">
                    {verificationEmailError}
                  </p>
                )}
              </div>
        ...
        <CardContent className="p-0">
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b-2 border-black bg-black text-white modal-header">
            ...
            <button
              ...
              disabled={isSubmitting || isSendingVerification || isVerifyingCode}
            >
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-t-2 border-black bg-gray-50 modal-footer">
            ...
            {currentStep === 1 || currentStep === 2 ? (
              ...
              >
                {currentStep === 2 && isSendingVerification ? (
                  <>
                    <div
