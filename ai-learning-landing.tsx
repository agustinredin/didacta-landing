  ...
  return (
    <ClientTranslator dict={en}>
      ...
      <div className="min-h-screen bg-white text-black font-mono">
        ...
        {/* Header/Hero Section */}
        <section className="relative mx-8 px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:pb-32 lg:pt-48 bg-white dark:bg-black">
        ...
        <section
          id="features"
          className="relative mx-8 px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 bg-white dark:bg-black"
        >
          <div className="max-w-6xl mx-auto">
            <AnimatedSection animation="fadeInUp">
              <div className="text-center mb-20">
              ...
              <div className="p-8 sm:p-12 lg:p-16">
                ...
                <div className="flex flex-wrap flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
                  <Button
                    size="lg"
                    onClick={() => setIsOnboardingOpen(true)}
                    className="text-xs sm:text-sm md:text-lg px-8 py-4 mono-button-orange border border-orange"
                  >
